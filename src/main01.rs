use iced::widget::{button, column, row, text, horizontal_space};
                     ...
                     if sdate.len() > 8 {
                         ...
                         if vecdatetime.len() == 3 {
                             ...
                             if vecdate.len() == 3 {
                                 ...
                                 if vectime.len() == 3 {
                                     let mo_int: i32 = vecdate[0].clone().parse().unwrap_or(-9999);
                                     if !(mo_int == -9999) {
                                         let da_int: i32 = vecdate[1].clone().parse().unwrap_or(-9999); 
                                         if !(da_int == -9999) {
                                             let yr_int: i32 = vecdate[2].clone().parse().unwrap_or(-9999); 
                                             if !(yr_int == -9999) {
                                                 let mut hr_int: i32 = vectime[0].clone().parse().unwrap_or(-9999); 
                                                 if !(hr_int == -9999) {
                                                     let mi_int: i32 = vectime[1].clone().parse().unwrap_or(-9999);
                                                     if !(mi_int == -9999) {
                                                         let se_int: i32 = vectime[2].clone().parse().unwrap_or(-9999); 
                                                         if !(se_int == -9999) {
                                                             if vecdatetime[2] == "PM" {
                                                                 if hr_int < 12 {
                                                                     hr_int = hr_int + 12;
